...
import src.Domain.Crew;
import src.Domain.Flight;
import src.Domain.GuestUser;
import src.Domain.Promotions;
...
public class DBController {
    ...
    public void removeUser(int userID){
        try {
            String statement = "DELETE FROM ALLUSERS WHERE userID = ?";
            flightQuery = flightConnect.prepareStatement(statement);
    ...
    public void removePromotion(int promotionID){
        try {
            String statement = "DELETE FROM PROMOTIONS WHERE promotionID = ?";
            flightQuery = flightConnect.prepareStatement(statement);
